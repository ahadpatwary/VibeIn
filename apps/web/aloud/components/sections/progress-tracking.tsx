...
export function ProgressTracking() {
   const h = 120;
   const grammarPts = points(
      months.map((m) => m.grammar),
      h,
   );
   const fluencyPts = points(
      months.map((m) => m.fluency),
      h,
   );
         ...
         <Container className="grid gap-14 lg:grid-cols-[0.85fr,1.15fr] lg:items-center">
            <div>
               ...
               <p className="mt-4 max-w-[46ch] text-[15.5px] leading-relaxed text-muted">
                  Aloud remembers your recurring mistakes — first detected, how often, and whether
                  they&apos;re fading. Your next practice recommendation is based on what&apos;s
