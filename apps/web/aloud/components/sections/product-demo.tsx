...
const transcript = [
  { text: "So Kafka is basically a... a message queue system, but it's actually more like a distributed log.", flag: "grammar" as const },
  { text: "Producers write to topics, and topics are split into partitions so you can scale horizontally.", flag: null },
  { text: "Consumers read from partitions with a offset, which tracks how far they've read.", flag: "grammar" as const },
  { text: "Unlike a traditional queue, messages aren't removed after reading — they're retained for a configured period.", flag: null },
];
...
const report = [
  ...
  { label: "Technical accuracy", score: "8.7", note: "Correct on partitions, offsets, retention" },
