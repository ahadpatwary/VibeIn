         ...
         <Container className="grid items-center gap-16 lg:grid-cols-[1.05fr,0.95fr]">
            <div className="animate-fade-up">
               ...
               <p className="mt-6 max-w-[46ch] text-[17px] leading-relaxed text-muted">
                  Talk about anything for as long as you want — English practice, a system design
                  walkthrough, an interview answer. No interruptions, no predefined questions. When
                  you&apos;re done, Aloud analyzes the whole session and shows you exactly how to
                  improve.
               </p>
            ...
            <div className="relative animate-fade-up [animation-delay:120ms]">
               ...
               <div className="absolute -bottom-8 -left-6 w-[240px] rounded-xl border border-border bg-surface p-4 shadow-lg sm:-left-10">
                  ...
                  <p className="mt-2 font-display text-2xl font-semibold">
                     7.4<span className="text-muted text-base font-normal">/10</span>
                  </p>
                  <div className="mt-3 space-y-1.5">
                     {[
                        ...
                        <div key={label as string} className="flex items-center gap-2">
                           <span className="w-[112px] shrink-0 text-[11px] text-muted">
                              {label}
                           </span>
