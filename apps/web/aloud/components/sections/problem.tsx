      ...
      <section className="border-t border-border py-24">
         <Container>
            ...
            <p className="mt-4 max-w-[58ch] text-[15.5px] leading-relaxed text-muted">
               Chat-style practice tools ask a question, wait for a short reply, then jump to the
               next one. That trains you to give short answers — not to think and speak the way you
               do in a real interview or presentation.
            </p>
