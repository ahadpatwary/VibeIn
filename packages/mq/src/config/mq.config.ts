import { RABBITMQ_CONFIG_CONSTANTS } from '../constants/mq.constants.js';
import { RabbitMQConfig, RequiredRabbitOpts } from '../types/mq.types.js';
...
export class RabbitMQConfigBuilder {
    ...
    setHartbit(heartbit?: number): this {
        this.config.heartbeat = heartbit;
        return this;
    }
    setChannelMax(maxChannel?: number): this {
        this.config.channelMax = maxChannel;
        return this;
    }

    setNoDelay(delay?: boolean): this {
        this.config.noDelay = delay;
        return this;
    }
    setTimeout(timeMs?: number): this {
        this.config.timeout = timeMs;
        return this;
    }
    setKeepAlive(alive?: boolean): this {
        this.config.keepAlive = alive;
        return this;
    }
    setKeepAliveDelay(aliveDelayMs?: number): this {
        this.config.keepAliveDelay = aliveDelayMs;
        return this;
    }

    setInitialDelay(delayMs?: number): this {
        this.config.initialDelay = delayMs;
        return this;
    }
    setMaxDelay(delayMs?: number): this {
        this.config.maxDelay = delayMs;
        return this;
    }
    setFactor(factor?: number): this {
        this.config.factor = factor;
        return this;
    }
...
export function createRabbitMQConfig(
    ...
    for (const field of requiredFields) {
        if (!config[field]) {
            throw new Error(
                `Environment variable missing or invalid: ${field}`,
            );
        }
    }
