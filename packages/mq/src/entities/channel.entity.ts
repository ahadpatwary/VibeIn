...
import { ExchangeConfig, QueueConfig, DLQConfig } from '../types/mq.types.js';
...
export class Channel {
   ...
   async assertExchange(ch: amqp.Channel, cfg: ExchangeConfig): Promise<void> {
   ...
   async assertQueue(ch: amqp.Channel, cfg: QueueConfig): Promise<amqp.Replies.AssertQueue> {
