...
export function mapMongooseError(error: unknown, context?: Record<string, unknown>): DatabaseException {
  ...
  if (mongoErr && typeof mongoErr === 'object' && (mongoErr.code === 11000 || mongoErr.code === 11001)) {
